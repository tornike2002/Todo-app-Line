    ...
    <div className="flex">
      ...
      <div className="w-full">
        ...
        <section className="px-4 mt-[32px]">
         ...
         shadow-custom-shadow py-[10px] px-[14px] w-full text-left sm:w-[60%]"
              onClick={boardToggle}
            >
              <span className="text-2xl">{board === false ? "+" : "-"}</span>{" "}
              Add a task
            </button>
          </div>
          {/* board */}
          <div className="w-full sm:flex sm:justify-center sm:items-center">
            {board && (
              <form
                className="sm:w-[60%] rounded-lg flex flex-col gap-3 shadow-custom-shadow p-3 mt-11"
                onSubmit={addTask}
              >
